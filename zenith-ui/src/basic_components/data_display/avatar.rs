...
pub fn avatar(
    ...
    let bg_color = format!("{}{}{}", "bg-[", ThemeValue::Theme.avatar_bg_color(theme_ctx.inner.as_str()), "]");
    let icon_color = format!("{}{}{}", "bg-[", ThemeValue::Theme.avatar_icon_color(theme_ctx.inner.as_str()), "]");
